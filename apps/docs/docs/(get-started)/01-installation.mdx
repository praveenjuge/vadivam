...
<Steps>
  <Step title="Install the package for your stack">
...
```
  ...
  <Step title="Use your package manager">
...
Use a named import in application code, then read [Import styles](#import-styles) for per-icon and asset paths:
