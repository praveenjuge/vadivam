...
export async function buildAngularPackage(icons, packageDir, root) {
  ...
  await write(
    generated,
    "runtime-policy.ts",
    `export type SVGElementType = ${svgElementTypeSource};\nexport type IconNode = readonly [tag: SVGElementType, attrs: Record<string, string | number | boolean>, children?: IconNode][];\n${runtimePolicyTypeScriptSource}`,
  );
  await write(
