...
import { iconNameType, iconNode, svgElementTypeSource, write } from "./shared.mjs";
import { runtimePolicyTypeScriptSource } from "./runtime-policy.mjs";
