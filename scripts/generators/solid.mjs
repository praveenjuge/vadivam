...
export async function buildSolidPackage(icons, dist) {
  ...
  await writeRuntimePolicy(dist);
  await write(dist, "source/runtimePolicy.js", `export * from "../runtimePolicy.js";\n`);
