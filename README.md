...
Vadivam is a free, open-source library of 505 pixel-perfect 24px outline SVG icons for React, React Native, Vue, Svelte, Solid, Angular, Astro, and Preact.
...
![All Vadivam icons](./apps/docs/public/preview.png?v=0.0.40)
